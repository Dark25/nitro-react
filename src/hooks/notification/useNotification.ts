...
const useNotificationState = () =>
{
    ...
    useMessageEvent<RespectReceivedEvent>(RespectReceivedEvent, event =>
    {
        ...
        showSingleBubble(text1, NotificationBubbleType.RESPECT, "https://mansionplay.com/ms-swf/c_images/notifications/respect.png");
        showSingleBubble(text2, NotificationBubbleType.RESPECT, "https://mansionplay.com/ms-swf/c_images/notifications/respect.png");
    });
